...
import {
  FilePickerModule,
  FilePreviewModel
} from "projects/file-picker-v2/src/public_api";
import { of } from "rxjs";
...
describe("FilePickerComponent", () => {
  ...
  beforeEach(() => {
    ...
    fixturePreviewContainer = TestBed.createComponent(
  ...
  it("shoud emit uploadSuccess when file is uploaded successfully", fakeAsync(() => {
    ...
    spyOn(MockableUploaderAdapter.prototype, "uploadFile").and.returnValue(
      of("123")
    );
    componentPreviewItem.fileItem = mockFilePreview;
    componentPreviewItem.ngOnInit();
